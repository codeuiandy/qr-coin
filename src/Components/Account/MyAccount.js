                        ...
                        <div className="account-body">
                                ...
                                <div className="body-item-container">
                                    ...
                                    <div className="item-lower-content item-right">
                                        <div className="lower-left btn-btn">
                                            <button className="account-btn">Verify level 1: Individual account</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="account-body-item">
                                ...
                                <div className="body-item-container">
                                    ...
                                    <div className="item-lower-content item-right">
                                        <div className="lower-left btn-btn">
                                            <button className="account-btn">Change country</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="account-body-item">
                                ...
                                <div className="body-item-container">
                                    ...
                                    <div className="item-lower-content item-right">
                                        <div className="lower-left btn-btn">
                                            <button className="account-btn">Manage</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
